...
const int g_TpVirtualKey[TPD_KEY_COUNT] = TPD_KEYS;
...
const int g_TpVirtualKeyDimLocal[TPD_KEY_COUNT][4] = TPD_KEYS_DIM;
...
s32 DrvPlatformLyrTouchDeviceRegisterFingerTouchInterruptHandler(void)
{
    ...
    {    	
        ...
        mt65xx_eint_registration(CUST_EINT_TOUCH_PANEL_NUM, CUST_EINT_TOUCH_PANEL_DEBOUNCE_EN, CUST_EINT_TOUCH_PANEL_POLARITY, _DrvPlatformLyrFingerTouchInterruptHandler, 1);
        mt65xx_eint_unmask(CUST_EINT_TOUCH_PANEL_NUM);
       ...
       _gThread = kthread_run(_DrvPlatformLyrFingerTouchHandler, 0, MSG_TP_IC_NAME);
