...
// Modify.
#include "open_test_RIU1_green.h"
#include "open_test_RIU2_green.h"
#include "open_test_RIU3_green.h"

//#include "open_test_RIU1_each.h"
//#include "open_test_RIU2_each.h"
//#include "open_test_RIU3_each.h"

// Modify.
#include "short_test_RIU1_green.h"
#include "short_test_RIU2_green.h"
#include "short_test_RIU3_green.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
#include "short_test_RIU4_green.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE

//#include "short_test_RIU1_each.h"
//#include "short_test_RIU2_each.h"
//#include "short_test_RIU3_each.h"
#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE  
//#include "short_test_RIU4_each.h"
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
#endif
...
static u16 _DrvMpTestItoTestChooseTpType(void)
{
    ...
    for (i = 0; i < 10; i ++)
    {
        ...
        if (TP_OF_GREEN == nTpType) // || TP_OF_EACH == nTpType) // Modify.
        {
            break;
        }
        else if (i < 5)
    ...
    if (TP_OF_GREEN == nTpType) // Modify. 
    {
...
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
#elif defined(CONFIG_ENABLE_CHIP_MSG22XX)
        _gOpenRIU1 = open_1_GREEN;
        _gOpenRIU2 = open_2_GREEN;
        _gOpenRIU3 = open_3_GREEN;

        _gShort_RIU1 = short_1_GREEN;
        _gShort_RIU2 = short_2_GREEN;
        _gShort_RIU3 = short_3_GREEN;

        _gOpenSubFrameNum1 = NUM_OPEN_1_SENSOR_GREEN;
        _gOpenSubFrameNum2 = NUM_OPEN_2_SENSOR_GREEN;
        _gOpenSubFrameNum3 = NUM_OPEN_3_SENSOR_GREEN;
        _gShortSubFrameNum1 = NUM_SHORT_1_SENSOR_GREEN;
        _gShortSubFrameNum2 = NUM_SHORT_2_SENSOR_GREEN;
        _gShortSubFrameNum3 = NUM_SHORT_3_SENSOR_GREEN;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
        _gShort_RIU4 = short_4_GREEN;
        _gShortSubFrameNum4 = NUM_SHORT_4_SENSOR_GREEN;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
#endif
        ...
        _gMAP2 = MAP2_GREEN;
        _gMAP3 = MAP3_GREEN;
        _gMAP40_1 = MAP40_1_GREEN;
        _gMAP40_2 = MAP40_2_GREEN;
        _gMAP41_1 = MAP41_1_GREEN;
        _gMAP41_2 = MAP41_2_GREEN;

        _gSHORT_MAP1 = SHORT_MAP1_GREEN;
        _gSHORT_MAP2 = SHORT_MAP2_GREEN;
        _gSHORT_MAP3 = SHORT_MAP3_GREEN;

#ifdef CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE       
        _gMAP40_3 = MAP40_3_GREEN;
        _gMAP40_4 = MAP40_4_GREEN;
        _gMAP41_3 = MAP41_3_GREEN;
        _gMAP41_4 = MAP41_4_GREEN;

        _gSHORT_MAP4 = SHORT_MAP4_GREEN;
#endif //CONFIG_ENABLE_MP_TEST_ITEM_FOR_2R_TRIANGLE
 
        _gItoTestKeyNum = NUM_KEY_GREEN;
        _gItoTestDummyNum = NUM_DUMMY_GREEN;
        _gItoTestTriangleNum = NUM_SENSOR_GREEN;
        _gIsEnable2R = ENABLE_2R_GREEN;
    }
	#if 0 //BEGIN: delete by fangjie for temp test. pixi3-4 don't support msg2238+each.
    else if (TP_OF_EACH == nTpType) // Modify. 
    {
#if defined(CONFIG_ENABLE_CHIP_MSG21XXA)
        _gOpen1 = open_1_Y;
        _gOpen1B = open_1B_Y;
    ...
    #endif  //END: delete by fangjie for temp test. pixi3-4 don't support msg2238+each.
    else
    {
        nTpType = 0;
    }
