...
extern void DmaAlloc_data(void);
extern void DmaFree_data(void);
...
extern s32 IicReadData_data(u8 nSlaveId, u8* pBuf, u16 nSize); //fangjie add for Rawdata test, report data use the different DMA buffer.
