 ...
 */
typedef enum {
    MSG22XX_SW_ID_EACH = 0x0005,
    MSG22XX_SW_ID_GREEN = 0x0008,  
    MSG22XX_SW_ID_UNDEFINED = 0x11
} Msg22xxSwId_e;
 ...
 */
typedef enum {
    MSG21XXA_SW_ID_EACH = 0x0005,  
    MSG21XXA_SW_ID_GREEN = 0x0008,
    MSG21XXA_SW_ID_UNDEFINED= 0x11
} Msg21xxaSwId_e;
