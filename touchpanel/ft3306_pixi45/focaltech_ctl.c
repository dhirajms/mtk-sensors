...
*
*/
int ft3306_i2c_Read(struct i2c_client *client, char *writebuf,
...
/*write data by i2c*/
int ft3306_i2c_Write(struct i2c_client *client, char *writebuf, int writelen)
{
	int ret;
...
{
	int ret = 0;	
	ret = ft3306_i2c_Read(client, NULL, 0, buf, length);
...
{
	int ret = 0;
	ret = ft3306_i2c_Write(client, buf, length);
	if(ret<0)
