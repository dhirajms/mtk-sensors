...
static struct LCM_setting_table lcm_initialization_setting_hx8379c_dijing[] = {
	...
	*/
	...
	{REGFLAG_DELAY, 5, {}},
	{0xB1,	20,	{0x44,0x18,0x18,0x31,0x51,
				  0x50,0xD0,0xEE,0x94,0x80,
				  0x38,0x38,0xF8,0x33,0x32,
				  0x22,0x00,0x80,0x30,0x00}},
  	{REGFLAG_DELAY, 5, {}},
	{0xB2,	9,	{0x82,0x3C,0x0C,0x03,0x00,
		                  0x50,0x11,0x42,0x1D}},
	{REGFLAG_DELAY, 5, {}},
	{0xB4,	10,	{0x11,0x7B,0x11,0x7B,0x11,
				  0x7B,0x0A,0x84,0x0A,0x84}},
	{REGFLAG_DELAY, 5, {}},
	{0xD2,	1,	{0x33}},
	{REGFLAG_DELAY, 5, {}},
	{0xD3,	35, {0x00,0x07,0x00,0x3C,0x01,
	                        0x08,0x08,0x32,0x10,0x01,
	                        0x00,0x01,0x03,0x72,0x03,
	                        0x72,0x00,0x08,0x00,0x08,
	                        0x33,0x33,0x05,0x05,0x37,
	                        0x05,0x05,0x37,0x0A,0x00,
	                        0x00,0x00,0x0A,0x00,0x11}},
	{REGFLAG_DELAY, 5, {}},
	{0xD5,	32, {0x19,0x19,0x18,0x18,0x1A,
	                       0x1A,0x1B,0x1B,0x02,0x03,
	                       0x00,0x01,0x06,0x07,0x04,
	                       0x05,0x20,0x22,0x21,0x23,
	                       0x18,0x18,0x18,0x18,0x18,
	                       0x18,0x18,0x18,0x18,0x18,
	                       0x18,0x18}},
	{REGFLAG_DELAY, 5, {}},
	{0xD6,	32, {0x18,0x18,0x19,0x19,0x1B,
	                        0x1B,0x1A,0x1A,0x05,0x04,
	                        0x07,0x06,0x01,0x00,0x03,
	                        0x02,0x23,0x22,0x21,0x20,
	                        0x18,0x18,0x18,0x18,0x18,
	                        0x18,0x18,0x18,0x18,0x18,
	                        0x18,0x18}},
	{REGFLAG_DELAY, 5, {}},
	{0xCC,	3, {0x02,0x01,0x00}},
	{REGFLAG_DELAY, 5, {}},
	{0xE0,	42, {0x00,0x00,0x00,0x0D,0x0F,
	                        0x3F,0x1D,0x32,0x04,0x0A,
	                        0x0E,0x19,0x12,0x16,0x19,
	                        0x16,0x16,0x08,0x13,0x14,
	                        0x19,0x00,0x00,0x00,0x0E,
	                        0x0E,0x3F,0x1E,0x32,0x05,
	                        0x08,0x0D,0x18,0x11,0x16,
	                        0x18,0x16,0x15,0x07,0x12,
	                        0x13,0x17}},
	{REGFLAG_DELAY, 5, {}},
	{0xB6,	2,	{0x80,0x80}},
	{REGFLAG_DELAY, 5, {}},
...
static void lcm_init(void)
{
	...
	push_table(lcm_initialization_setting_hx8379c_dijing, sizeof(lcm_initialization_setting_hx8379c_dijing) / sizeof(struct LCM_setting_table), 1);
}
...
static unsigned int lcm_compare_id()
{
	...
	if (id_type == 3 ) //hx8379c_dijing as 3rd  source ,and ID_tpye is 11bit.
	{
		return 1;
	}
	else
...
// ---------------------------------------------------------------------------
LCM_DRIVER hx8379c_wvga_dsi_vdo_dijing_6572_lcm_drv = 
{
    .name		= "hx8379c_wvga_dsi_vdo_dijing_6572",
