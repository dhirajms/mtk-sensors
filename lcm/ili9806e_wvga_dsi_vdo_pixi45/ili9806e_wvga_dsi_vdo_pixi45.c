...
static unsigned int lcm_esd_check(void)
{
	...
	//MDELAY(10); //modify by xiaopu.zhu for defect 124151 anti-flicker
	UDELAY(600);
	array[0] = 0x00013700;
...
// ---------------------------------------------------------------------------
LCM_DRIVER ili9806e_wvga_dsi_vdo_6572_lcm_drv_pixi45 =
{
	.name			= "ili9806e_wvga_dsi_vdo_6572_pixi45",
